package org.abhishek.bookstore.jersey.service.impl;

import org.abhishek.bookstore.jersey.service.config.JerseyServiceConfigHolder;
import org.abhishek.bookstore.jersey.service.exception.CustomException;
...
public class MyResource {
    ...
    @Inject
    JerseyServiceConfigHolder jerseyServiceConfigHolder;
    ...
    public String getEnvironmentMessage(@QueryParam("env") String env) {
        return ("Environment: " + jerseyServiceConfigHolder.getMessageForService(env));
    }
